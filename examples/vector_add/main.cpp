#include <cstdio>
#include <cstdint>
#include <cuda_runtime.h>  // same as real CUDA

// Generated by ptx2cpp.py — void* convenience overload
void vectorAdd_launch(const void*, const void*, const void*, uint32_t,
                      dim3, dim3);
